...
const config = {
  ...
  "inlineSchemaHash": "63652fea2d52dfcc11418e17c6886073189289947e56f207d33a3dd56df7b126",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/.prisma/backend-client",
    ".prisma/backend-client",
  ]
...
path.join(process.cwd(), "prisma/.prisma/backend-client/libquery_engine-darwin.dylib.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "prisma/.prisma/backend-client/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/.prisma/backend-client/schema.prisma")
